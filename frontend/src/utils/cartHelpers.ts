...
export function onClickAddToCart(e: { preventDefault: any }, item: object) {
...
export const getCartPriceTotal = (shoppingCartItems) => shoppingCartItems.reduce(
		(sum, { quantity, price }) => sum + quantity * price,
		0,
	);

export const formatCartData = (rawCartData) => rawCartData.map(
